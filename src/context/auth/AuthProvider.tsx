...
import type { LoginValues, RegisterValues, StoredAuthUser } from "../../types/auth";
import { AuthContext, type AuthContextValue } from "../authStore";
import { readStoredSession, readStoredUsers, writeStoredSession, writeStoredUsers } from "./auth.storage";
import { removePasswordFromUser, sanitizeEmail, sanitizeName } from "./auth.utils";
...
export const AuthProvider = ({ children }: AuthProviderProps) => {
  ...
  const register = useCallback(
    async ({ name, email, password, confirmPassword }: RegisterValues) => {
